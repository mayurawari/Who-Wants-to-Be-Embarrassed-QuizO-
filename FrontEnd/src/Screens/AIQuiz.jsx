...
const fetchQuizData = async (topic) => {
  const res = await fetch("https://who-wants-to-be-embarrassed-quiz-o.vercel.app/api/AIquestions", {
    method: "POST",
...
export const AIQuiz = () => {
  ...
  const handleAnswersVisible = (obj) => {
    ...
    try {
      ...
      localStorage.setItem("AIquiz_selectedAnswers", JSON.stringify(next));
    } catch {}
  };
